...
- **2026-03-10**: [[openai|OpenAI]] Acquires Promptfoo to Strengthen AI Security Testing · [OpenAI Blog](https://openai.com/index/openai-to-acquire-promptfoo) · [@OpenAI](https://x.com/OpenAI/status/2031052793835106753)
- **2026-03-07**: [[openai|OpenAI]] Releases [[codex|Codex]] Security in Research Preview · [OpenAI Blog](https://openai.com/index/codex-security-now-in-research-preview) · [@OpenAI](https://x.com/OpenAI/status/2029985250512920743)
- **2026-03-04**: Study Reveals AI-Generated Code Security Crisis: Only 10% is Secure · [VentureBeat](https://venturebeat.com/technology/endor-labs-launches-free-tool-auri-after-study-finds-only-10-of-ai-generated)
- **2026-03-02**: Arxiv: Controllable Reasoning Models Can Protect Private Information in [[agent-frameworks|AI Agent]] Traces · [Arxiv](http://arxiv.org/abs/2602.24210v1)
