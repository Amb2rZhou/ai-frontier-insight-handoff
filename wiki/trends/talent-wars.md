...
- **2026-04-22**: SpaceX Announces Option to Acquire AI Coding Startup [[cursor-ai|Cursor]] for $60B
- **2026-04-21**: [[anthropic|Anthropic]] Secures $5B from Amazon with $100B AWS Spending Commitment
- **2026-04-19**: Yann LeCun Criticizes Dario Amodei's Views on AI Labor Market Impact
- **2026-04-18**: [[openai|OpenAI]] [[sora|Sora]] Team Lead Bill Peebles and Exec Kevin Weil Depart
...
- **2026-04-11**: Anthropic Temporarily Bans [[openclaw|OpenClaw]] Creator
...
- **2026-02-27**: OpenAI expands London research hub to compete directly with [[google-deepmind|DeepMind]] for UK AI talent
- **2026-02-25**: OpenAI defeats [[xai|xAI]]'s trade secrets lawsuit
- **2026-02-25**: OpenAI defeats xAI's trade secrets lawsuit, legal battle continues

## Key Developments

### Legal Battles
[[openai|OpenAI]] defeated [[xai|xAI]]'s trade secrets lawsuit (Feb 25). Faced $10M lawsuit over AI hallucination (Mar 9). NeurIPS reversed policy after backlash from Chinese researchers (Mar 28).

### Acquisitions
[[openai|OpenAI]] acquired Promptfoo (Mar 10), Astral (Mar 20), TBPN podcast (Apr 3), Hiro (Apr 14). [[anthropic|Anthropic]] acquired Vercept (Feb 26). [[meta|Meta]] hired Dreamer team (Mar 24). SpaceX option to acquire [[cursor-ai|Cursor]] for $60B (Apr 22).

### Funding
[[openai|OpenAI]] completed $122B round at $852B valuation (Apr 1). [[anthropic|Anthropic]] $5B from Amazon (Apr 21). OpenAI alums raised $100M "Zero Shot" fund (Apr 7). AI companies raised more in Q1 2026 than all of 2025 (a16z, Apr 11).
