...
[[google-deepmind|Google]]'s [[open-source-models|open-source]] model family released under Apache 2.0, designed for edge deployment and [[agent-frameworks|agent]] workloads.
...
- **2026-04-17**: [[google-deepmind|Google]] Releases Gemma 4, a Flexible Model Family for Scalable Agents and Edge · [@googledevs (Google)](https://x.com/googledevs/status/2044611741842079970)
- **2026-04-10**: Unsloth AI Enables Free Fine-Tuning of Gemma 4 31B on Kaggle · [Unsloth AI on X](https://x.com/UnslothAI/status/2042269554253140048)
- **2026-04-07**: [[google-deepmind|Google]] Releases Offline-First AI Dictation App Using Gemma · [TechCrunch](https://techcrunch.com/2026/04/06/google-quietly-releases-an-offline-first-ai-dictation-app-on-ios/)
- **2026-04-07**: [[ollama|Ollama]] Cloud Launches Subscription for Running Gemma 4 · [Ollama Twitter](https://x.com/ollama/status/2041238722914685336)
